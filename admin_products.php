...
if (isset($_POST['add_product'])) {
   ...
   if (mysqli_num_rows($select_product_name) > 0) {
       ...
       if ($image_size > 2000000) {
           ...
           $insert_product = mysqli_query($conn, "INSERT INTO `products`(name, details, price, image, category_id, subcategory_id) VALUES('$name', '$details', '$price', '$image', '$category_id', '$subcategory_id')") or die('query failed');
